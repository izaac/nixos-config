...
| `command not found`        | PATH missing in Distrobox          | Check the PATH/export setup in `home/distrobox.nix` (helpers live in `distrobox/bin`, first in PATH)                                                                                |
| `atuin` not saving history | Shell hook not loaded              | Check the `atuin` block in `home/shell/programs.nix`                                                                                                                                |
