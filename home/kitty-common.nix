# Shared kitty settings + keybindings for Linux (home/kitty.nix) and
# Darwin (home/darwin/kitty.nix). Per-platform files merge these into
# programs.kitty and add their own extras on top.
{
  settings = {
