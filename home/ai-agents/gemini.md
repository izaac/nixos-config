...
- For Cypress-to-Playwright porting, or mass syntax translation across multiple files: **NEVER** do
  it directly in main chat.
- **ALWAYS** use `invoke_agent` to spawn the `generalist` subagent to do the heavy lifting in the
  background.
